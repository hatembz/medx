...
import 'package:medx/ui/auth/sign_in/reset_password_screen.dart';
...
class _CodeVerificationScreenState extends State<CodeVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Forgot Password', style: context.textTheme.headlineMedium)),
        bottomNavigationBar: Padding(
          padding: EdgeInsets.symmetric(horizontal: 24, vertical: context.height * 0.045),
          child: CustomButton(
            title: 'Verify',
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Text('invalid verification code',
                        style: context.textTheme.labelSmall?.copyWith(color: kRedColor))
                  ]),
                ),
              ),
              gap(context),
              timeLeft == 0
                  ...
                  : RichText(
                      ...
                      TextSpan(text: "Resend code in ", style: context.textTheme.displaySmall),
                      TextSpan(
                          text: "$timeLeft",
                          style: context.textTheme.bodyMedium?.copyWith(color: kBlueColor)),
                      TextSpan(text: " s", style: context.textTheme.displaySmall),
                    ])),
            ],
          ),
        ));
