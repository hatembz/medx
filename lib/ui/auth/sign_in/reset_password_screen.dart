...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('reset Password', style: context.textTheme.headlineMedium)),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            gap(context),
            Text('create new password', style: context.textTheme.labelSmall),
            gap(context),
            Padding(
              padding: const EdgeInsets.only(left: 16, bottom: 8),
              child: Text('New Password', style: context.textTheme.displaySmall),
            ),
            CustomTextField(
              hintText: 'Password',
              obscureText: true,
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16, bottom: 8),
              child: Text('Confirme New Password', style: context.textTheme.displaySmall),
            ),
            CustomTextField(
              hintText: 'Password',
              obscureText: true,
