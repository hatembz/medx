...
import 'package:medx/ui/auth/sign_in/code_verification_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('via SMS:', style: context.textTheme.labelSmall),
                          SizedBox(
                            width: double.infinity,
                            child: Text(
                              '+6282******39',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('via Email:', style: context.textTheme.labelSmall),
                          SizedBox(
                            width: double.infinity,
                            child: Text(
            ...
            gap(context, context.height * 0.048)
          ],
        ),
      ),
    );
